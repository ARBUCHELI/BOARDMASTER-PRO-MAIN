...
import { Plus, FolderKanban, Loader2, Calendar, Users } from "lucide-react";
      ...
      {projects.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <Card
              key={project.id}
              className="cursor-pointer hover:shadow-lg transition-all hover:scale-[1.02] animate-slide-in-up"
